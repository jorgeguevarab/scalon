...
- **Área de notificaciones** (pestaña "Avisos"): un panel calculado en el momento a partir de tus hábitos — rachas activas y cuánto falta para la siguiente medalla, hábitos sin marcar hoy, hábitos "olvidados" (sin ningún progreso en 3+ días) y sugerencias del motor de recomendaciones. Un punto rojo en la pestaña avisa cuando hay algo pendiente.
